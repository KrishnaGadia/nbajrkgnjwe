...
public class UIPupil {
    ...
    file.add(quit);     
    */
    // Disabling the buttons - Pupils will not have the rights to draw/write on the Whiteboard
    ...
    // After selecting TINY ERASER, you need to click on ERASER button again to eraser
    ...
    // After selecting BIG ERASER, you need to click on ERASER button again to eraser
   ...
   // Pink Implementation
					...
					//System.out.println("Co-od: " + ServerInput);
						...
						switch(type){
							...
							case 'F': Color t = g.getColor();
        							...
        							g.setColor(t);
											break;
							case 'T' :  System.out.println("Hi");			//enableButton();	
	...
	public static void enableButton(){
 		// Enable the buttons - Pupils will have the rights to draw/write on the Whiteboard because of the TOKEN
    blue_button.setEnabled(true);
    red_button.setEnabled(true);
    green_button.setEnabled(true);
    black_button.setEnabled(true);
